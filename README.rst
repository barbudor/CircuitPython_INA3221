...
Pick only one depending your needs. On processors with limited amount of memory, the lite version
is recommended. You may want to use `mpy-cross`to precompile the library to an `.mpy` file
